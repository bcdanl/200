...
- On your laptop, access the SCE form for DANL 200 as follows:
- Here are the web-link and steps to do so:
  ...
  4. Choose DANL 200 (class for which you want to fill out the SCE) and then complete the SCE survey.
