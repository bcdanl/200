...
- Be systematic when naming a series of files in the website.
  - E.g., `danl-200-cw-01.qmd`, `danl-200-cw-02.qmd`, `danl-200-cw-03.qmd`.
...
![](https://bcdanl.github.io/lec_figs/quarto-blog.gif)
- After posting a new blog locally, do not forget using the 3-step `git` commands to update your online website with the new blog post.
...
2. Add a link of page of "R Basics" to the navigation bar using `danl-200-quarto.qmd`.
